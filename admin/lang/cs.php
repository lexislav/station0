...
return [
    ...
    'nav_tasks'           => 'Úlohy',
    'tasks_title'         => 'Úlohy',
    'tasks_empty'         => 'Žádné úlohy. Úloha je PHP soubor v <code>site/tasks/</code>.',
    'tasks_th_task'       => 'Úloha',
    'tasks_th_last_run'   => 'Poslední běh',
    'tasks_open'          => 'Otevřít',
    'tasks_run'           => 'Spustit',
    'tasks_running'       => 'Běží…',
    'tasks_run_heading'   => 'Běh',
    'tasks_history'       => 'Poslední běhy',
    'tasks_hooks'         => 'Spouští se automaticky při:',
    'tasks_source_hook'   => 'hook',
    'tasks_never_run'     => 'zatím nespuštěno',
    'tasks_status_queued'      => 've frontě',
    'tasks_status_running'     => 'běží',
    'tasks_status_done'        => 'OK',
    'tasks_status_failed'      => 'chyba',
    'tasks_status_skipped'     => 'přeskočeno',
    'tasks_status_interrupted' => 'přerušeno',
    'tasks_no_output'     => 'Žádný výstup.',
    'task_err_required'   => 'Toto pole je povinné.',
    'task_err_invalid'    => 'Neplatná hodnota.',
